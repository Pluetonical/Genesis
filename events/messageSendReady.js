...
module.exports = {
  ...
  async execute(client) {
    const ticketChannel = await client.guilds.cache.get('997001983875616788').channels.fetch('997002361035821126');
    const collection = await ticketChannel.messages.fetch();
    const ticketStaffChannel = await client.guilds.cache.get('997001983875616788').channels.fetch('997002362138927104');
    const staffCollection = await ticketStaffChannel.messages.fetch();
    const roleChannel = await client.guilds.cache.get('997001983875616788').channels.fetch('997002355033767986');
    const roleCollection = await roleChannel.messages.fetch();
    const verifychannel = await client.guilds.cache.get('997001983875616788').channels.fetch('997002333886091314');
