...
module.exports = {
  ...
  async execute(message) {
    ...
    message.guild.channels.cache.get('997002423468052480').send({ embeds: [new Discord.MessageEmbed().setColor(0xffcd00).setTitle("<:atlanta_folder:601019084468912129> New Suggestion").setDescription(`**Suggested by ${message.author.tag}**\n\n**Content:**\n${message.content}\n\n**Status:** -`).setFooter(message.author.id)], components: [button] });
  }
};